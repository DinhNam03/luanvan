...
WHERE table_name = 'd_items' AND table_schema = 'mimiciv_icu';

SELECT column_name, data_type FROM information_schema.columns 
WHERE table_name = 'chartevents' AND table_schema = 'mimiciv_icu';

SELECT column_name, data_type FROM information_schema.columns 
WHERE table_name = 'admissions' AND table_schema = 'mimiciv_hosp';
